...
namespace ET
{
    ...
    [MemoryPackable]
    [Message(OuterMessage.HttpGetFileResponse)]
    public partial class HttpGetFileResponse : MessageObject
    {
        public static HttpGetFileResponse Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(HttpGetFileResponse), isFromPool) as HttpGetFileResponse;
        }
    ...
    public static class OuterMessage
    {
        ...
        public const ushort HttpGetFileResponse = 10003;
